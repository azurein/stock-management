 <div class="grid_12">
    ...
    <div class="box round first fullpage">
        <h2>Daftar SPK Terdaftar</h2>
        <div style="padding-top: 20px;padding-left: 10px"><a href="insert_spk"><button type="button" class="btn btn-blue">Masukkan SPK Baru.</button><a/></div>
        <div class="block">
