...
<head>
    ...
    <script language="javascript" type="text/javascript" src="<?php echo base_url(); ?>staff_site_files/s/jqPlot/plugins/jqplot.highlighter.min.js"></script>
                ...
                <div class="floatright">
                    ...
                    <div class="floatleft marginleft10">
                        <ul class="inline-ul floatleft">
                            <li><font style="text-transform: uppercase">selamat datang! <?php foreach($results as $row) { echo $row->posisiEmp; } ?> <?php foreach($results as $row) { echo $row->namaEmp; } ?></font></li>
